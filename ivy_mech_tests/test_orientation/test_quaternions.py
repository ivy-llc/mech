...
def test_vector_and_angle_to_quaternion(device, call):
...
def test_axis_angle_to_quaternion(device, call):
...
def test_rot_mat_to_quaternion(device, call):
...
def test_rotation_vector_to_quaternion(device, call):
...
def test_hamilton_product(device, call):
