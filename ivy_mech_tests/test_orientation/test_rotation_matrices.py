...
def test_axis_angle_to_rot_mat(device, call):
...
def test_rot_vec_to_rot_mat(device, call):
...
def test_quaternion_to_rot_mat(device, call):
...
def test_euler_to_rot_mat(device, call):
...
def test_get_random_rot_mat(device, call):
