...
def test_euler_pose_to_axis_angle_pose(dev_str, call):
...
def test_mat_pose_to_rot_vec_pose(dev_str, call):
...
def test_quaternion_pose_to_rot_vec_pose(dev_str, call):
