...
def test_axis_angle_pose_to_quaternion_pose(device, call):
...
def test_mat_pose_to_quaternion_pose(device, call):
...
def test_euler_pose_to_quaternion_pose(device, call):
...
def test_increment_quaternion_pose_with_velocity(device, call):
