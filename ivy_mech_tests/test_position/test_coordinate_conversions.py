...
def test_polar_to_cartesian_coords(device, call):
...
def test_cartesian_to_polar_coords(device, call):
...
def test_cartesian_to_polar_coords_and_back(device, call):
...
def test_polar_to_cartesian_coords_and_back(device, call):
