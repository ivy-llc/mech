...
def axis_angle_to_quaternion(axis_angle):
    ...
    # BS x 4
    quaternion = _ivy.concat((e1, e2, e3, n), -1, out=None)
    return quaternion
...
def polar_axis_angle_to_quaternion(polar_axis_angle):
    ...
    # BS x 3
    vector = _ivy.concat((x, y, z), -1)

    # BS x 4
    return axis_angle_to_quaternion(_ivy.concat([vector, angle], -1, out=None))
...
def rot_mat_to_quaternion(rot_mat):
    ...
    # BS x 4 x 1
    quat_1 = _ivy.concat((qx_1, qy_1, qz_1, qw_1), -2, out=None)
    ...
    # BS x 4 x 1
    quat_2 = _ivy.concat((qx_2, qy_2, qz_2, qw_2), -2, out=None)
    ...
    # BS x 4 x 1
    quat_3 = _ivy.concat((qx_3, qy_3, qz_3, qw_3), -2, out=None)
    ...
    # BS x 4 x 1
    quat_4 = _ivy.concat((qx_4, qy_4, qz_4, qw_4), -2, out=None)
    quat_3_or_other = _ivy.where(rot_mat[..., 1:2, 1:2] > rot_mat[..., 2:3, 2:3],
                                 quat_3, quat_4)
    quat_2_or_other = \
...
def rotation_vector_to_quaternion(rot_vector):
    ...
    # BS x 4
    return axis_angle_to_quaternion(_ivy.concat([vector, theta], -1, out=None))
...
def euler_to_quaternion(euler_angles, convention='zyx', batch_shape=None):
    ...
    return rot_mat_to_quaternion(
        _ivy_rot_mat.euler_to_rot_mat(euler_angles, convention, batch_shape))
...
def inverse_quaternion(quaternion):
    ...
    vector_conjugate = _ivy.concat((-quaternion[..., 0:3], quaternion[..., -1:]), -1, out=None)
...
def get_random_quaternion(max_rot_ang=_math.pi, batch_shape=None):
    ...
    # BS x 4
    return axis_angle_to_quaternion(_ivy.concat([quaternion_vector, theta], -1, out=None))
...
def scale_quaternion_rotation_angle(quaternion, scale):
    ...
    # BS x 4
    return axis_angle_to_quaternion(_ivy.concat(
        [vector_and_angle[..., :-1], scaled_angle], -1, out=None))
...
def hamilton_product(quaternion1, quaternion2):
    ...
    # BS x 4
    return _ivy.concat((term_i, term_j, term_k, term_r), -1, out=None)
