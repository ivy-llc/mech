...
def make_transformation_homogeneous(matrices, batch_shape=None, dev=None):
    """
    ...
    # BS x 1 x 4
    last_row = _ivy.tile(_ivy.reshape(_ivy.array([0., 0., 0., 1.], dev=dev), [1] * num_batch_dims + [1, 4]),
                         batch_shape + [1, 1])
